          ...
          reviews: [
            {
              ...
              locationText: 'No primeiro espaço intercostal, 6 cun lateral à linha mediana.',
              actions: ['Difunde o Qi do Pulmão.'],
              indications: ['tosse', 'dispneia'],
            },
            {
              code: 'HT7',
              status: 'approved_local',
              ...
              approvalMethod: 'bulk_high_confidence_operator_request',
              locationText: 'Na prega do punho, lado radial do tendão flexor ulnar do carpo.',
              actions: ['Acalma a mente.'],
              indications: ['insônia', 'palpitações'],
            },
          ],
        }),
      };
