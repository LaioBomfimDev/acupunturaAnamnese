// ============================================================
// DADOS: Todos os checklists e opções de seleção do sistema
// ============================================================

export const checklists = {
  objetivos: [
    "Reduzir dor", "Regular sono", "Reduzir ansiedade", "Melhorar digestão",
    "Melhorar intestino", "Reduzir edema", "Regular ciclo", "Melhorar energia"
  ],
  sintomas: [
    "Ansiedade", "Insônia", "Irritabilidade", "Raiva", "Tristeza", "Medo",
    "Cefaleia", "Enxaqueca", "Tontura", "Zumbido", "Palpitação", "Refluxo",
    "Azia", "Náusea", "Distensão abdominal", "Constipação", "Diarreia",
    "Edema", "Fadiga", "TPM", "Cólicas", "Dor lombar", "Dor cervical",
    "Rinite/Sinusite", "Problemas de pele"
  ],
  queixaEstruturada: [
  ...
  lingua: [
    ...
    "Saburra branca", "Saburra amarela", "Saburra espessa", "Saburra gordurosa",
    "Sem saburra", "Ressecada", "Úmida", "Tremor", "Desvio"
  ],
  regioesLingua: [
    "Ponta/Coração", "Laterais/Fígado-VB", "Centro/Baço-Estômago",
    "Raiz/Rim-Intestinos", "Sublingual/Estagnação"
  ],
  clima: [
  ...
  oito: [
    "Interno", "Externo", "Frio", "Calor", "Deficiência", "Excesso", "Yin", "Yang"
  ],
  substancias: [
    "Qi", "Xue/Sangue", "Yin", "Yang", "Jing", "Jin Ye/Fluidos",
    "Fleuma", "Umidade", "Estase de Sangue"
  ],
  seguranca: [
