-- ==========================================================
-- Tipo de profissional (profissão) no cadastro
-- Abre o sistema para fisioterapeutas, psicólogos, psiquiatras,
-- nutricionistas etc. — não apenas acupunturistas. Guarda a
-- profissão escolhida e devolve também o clinic_id no painel para
-- o select de clínicas existentes (vínculo via clinic_id).
-- ==========================================================
...
-- ----------------------------------------------------------
-- admin_list_profiles: passa a expor profession e clinic_id
-- ----------------------------------------------------------
...
-- ----------------------------------------------------------
-- admin_update_profile: aceita p_profession (parâmetro adicional
-- com DEFAULT para manter compatibilidade com chamadas antigas)
-- ----------------------------------------------------------
