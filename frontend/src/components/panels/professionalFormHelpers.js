...
export function buildProfessionalCreatePayload(form, clinics = []) {
  ...
  return {
    ...
    enderecoCep: String(form?.enderecoCep || '').trim(),
    enderecoLogradouro: String(form?.enderecoLogradouro || '').trim(),
    enderecoNumero: String(form?.enderecoNumero || '').trim(),
    enderecoComplemento: String(form?.enderecoComplemento || '').trim(),
    enderecoBairro: String(form?.enderecoBairro || '').trim(),
    enderecoCidade: String(form?.enderecoCidade || '').trim(),
    enderecoUf: String(form?.enderecoUf || '').trim(),
