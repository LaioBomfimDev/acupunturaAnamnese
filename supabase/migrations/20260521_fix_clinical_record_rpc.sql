-- ==========================================================
-- Correção das RPCs de fichas clínicas para Supabase hosted
--
-- Motivos:
-- 1. Supabase hosted não permite depender de current_setting()
--    para variáveis customizadas como app.encryption_key.
-- 2. A extensão pgcrypto normalmente fica no schema extensions.
--    Por isso o search_path das funções inclui public e extensions.
-- ==========================================================
